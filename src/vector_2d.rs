...
impl Mul<Float> for Vector2D {
    ...
    fn mul(self, rhs: Float) -> Vector2D {
...
// Vecotr2D/f64
impl Div<Float> for Vector2D {
    type Output = Vector2D;
    fn div(self, rhs: Float) -> Vector2D {
        Vector2D {
            x: self.x / rhs,
            y: self.y / rhs,
        }
...
impl Vector2D {
    pub fn new(x: Float, y: Float) -> Vector2D {
        Vector2D { x: x, y: y }
    }

    pub fn length(v: &Vector2D) -> Float {
    ...
    pub fn dot(v1: &Vector2D, v2: &Vector2D) -> Float {
        v1.x * v2.x + v1.y * v2.y
    }
    ...
    pub fn mul(v: &Vector2D, d: Float) -> Vector2D {
        Vector2D {
            x: v.x * d,
            y: v.y * d,
        }
