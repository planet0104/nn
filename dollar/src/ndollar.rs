...
impl Multistroke {
    fn new(name: &str, use_bounded_rotation_invariance: bool, strokes: Vec<Vec<Point>>) -> Multistroke {
        ...
        Multistroke {
            name: name.to_string(),
            unistrokes: unistrokes.iter().map(|points|{
                Unistroke::new(name, use_bounded_rotation_invariance, points.clone())
            }).collect(),
            num_strokes
        }
    }
...
impl NDollarRecognizer{
    pub fn new(use_bounded_rotation_invariance: bool) -> NDollarRecognizer{
        ...
        multistrokes.push(Multistroke::new("T", use_bounded_rotation_invariance, vec![
            vec![Point::new(30,7),Point::new(103,7)],
            vec![Point::new(66,7),Point::new(66,87)]
        ]));
        multistrokes.push(Multistroke::new("N", use_bounded_rotation_invariance, vec![
            vec![Point::new(177,92),Point::new(177,2)],
            vec![Point::new(182,1),Point::new(246,95)],
            vec![Point::new(247,87),Point::new(247,1)]
        ]));
        multistrokes.push(Multistroke::new("D", use_bounded_rotation_invariance, vec![
            vec![Point::new(345,9),Point::new(345,87)],
            vec![Point::new(351,8),Point::new(363,8),Point::new(372,9),Point::new(380,11),Point::new(386,14),Point::new(391,17),Point::new(394,22),Point::new(397,28),Point::new(399,34),Point::new(400,42),Point::new(400,50),Point::new(400,56),Point::new(399,61),Point::new(397,66),Point::new(394,70),Point::new(391,74),Point::new(386,78),Point::new(382,81),Point::new(377,83),Point::new(372,85),Point::new(367,87),Point::new(360,87),Point::new(355,88),Point::new(349,87)]
        ]));
        multistrokes.push(Multistroke::new("P", use_bounded_rotation_invariance, vec![
            vec![Point::new(507,8),Point::new(507,87)],
            vec![Point::new(513,7),Point::new(528,7),Point::new(537,8),Point::new(544,10),Point::new(550,12),Point::new(555,15),Point::new(558,18),Point::new(560,22),Point::new(561,27),Point::new(562,33),Point::new(561,37),Point::new(559,42),Point::new(556,45),Point::new(550,48),Point::new(544,51),Point::new(538,53),Point::new(532,54),Point::new(525,55),Point::new(519,55),Point::new(513,55),Point::new(510,55)]
        ]));
        multistrokes.push(Multistroke::new("X", use_bounded_rotation_invariance, vec![
            vec![Point::new(30,146),Point::new(106,222)],
            vec![Point::new(30,225),Point::new(106,146)]
        ]));
        multistrokes.push(Multistroke::new("H", use_bounded_rotation_invariance, vec![
            vec![Point::new(188,137),Point::new(188,225)],
            vec![Point::new(188,180),Point::new(241,180)],
            vec![Point::new(241,137),Point::new(241,225)]
        ]));
        multistrokes.push(Multistroke::new("I", use_bounded_rotation_invariance, vec![
            vec![Point::new(371,149),Point::new(371,221)],
            vec![Point::new(341,149),Point::new(401,149)],
            vec![Point::new(341,221),Point::new(401,221)]
        ]));
        multistrokes.push(Multistroke::new("exclamation", use_bounded_rotation_invariance, vec![
            vec![Point::new(526,142),Point::new(526,204)],
            vec![Point::new(526,221)]
        ]));
        multistrokes.push(Multistroke::new("line", use_bounded_rotation_invariance, vec![
            vec![Point::new(12,347),Point::new(119,347)]
        ]));
        multistrokes.push(Multistroke::new("five-point star", use_bounded_rotation_invariance, vec![
            vec![Point::new(177,396),Point::new(223,299),Point::new(262,396),Point::new(168,332),Point::new(278,332),Point::new(184,397)]
        ]));
        multistrokes.push(Multistroke::new("null", use_bounded_rotation_invariance, vec![
            vec![Point::new(382,310),Point::new(377,308),Point::new(373,307),Point::new(366,307),Point::new(360,310),Point::new(356,313),Point::new(353,316),Point::new(349,321),Point::new(347,326),Point::new(344,331),Point::new(342,337),Point::new(341,343),Point::new(341,350),Point::new(341,358),Point::new(342,362),Point::new(344,366),Point::new(347,370),Point::new(351,374),Point::new(356,379),Point::new(361,382),Point::new(368,385),Point::new(374,387),Point::new(381,387),Point::new(390,387),Point::new(397,385),Point::new(404,382),Point::new(408,378),Point::new(412,373),Point::new(416,367),Point::new(418,361),Point::new(419,353),Point::new(418,346),Point::new(417,341),Point::new(416,336),Point::new(413,331),Point::new(410,326),Point::new(404,320),Point::new(400,317),Point::new(393,313),Point::new(392,312)],
            vec![Point::new(418,309),Point::new(337,390)]
        ]));
        multistrokes.push(Multistroke::new("arrowhead", use_bounded_rotation_invariance, vec![
            vec![Point::new(506,349),Point::new(574,349)],
            vec![Point::new(525,306),Point::new(584,349),Point::new(525,388)]
        ]));
        multistrokes.push(Multistroke::new("pitchfork", use_bounded_rotation_invariance, vec![
            vec![Point::new(38,470),Point::new(36,476),Point::new(36,482),Point::new(37,489),Point::new(39,496),Point::new(42,500),Point::new(46,503),Point::new(50,507),Point::new(56,509),Point::new(63,509),Point::new(70,508),Point::new(75,506),Point::new(79,503),Point::new(82,499),Point::new(85,493),Point::new(87,487),Point::new(88,480),Point::new(88,474),Point::new(87,468)],
            vec![Point::new(62,464),Point::new(62,571)]
        ]));
        multistrokes.push(Multistroke::new("six-point star", use_bounded_rotation_invariance, vec![
            vec![Point::new(177,554),Point::new(223,476),Point::new(268,554),Point::new(183,554)],
            vec![Point::new(177,490),Point::new(223,568),Point::new(268,490),Point::new(183,490)]
        ]));
        multistrokes.push(Multistroke::new("asterisk", use_bounded_rotation_invariance, vec![
            vec![Point::new(325,499),Point::new(417,557)],
            vec![Point::new(417,499),Point::new(325,557)],
            vec![Point::new(371,486),Point::new(371,571)]
        ]));
        multistrokes.push(Multistroke::new("half-note", use_bounded_rotation_invariance, vec![
            vec![Point::new(546,465),Point::new(546,531)],
            vec![Point::new(540,530),Point::new(536,529),Point::new(533,528),Point::new(529,529),Point::new(524,530),Point::new(520,532),Point::new(515,535),Point::new(511,539),Point::new(508,545),Point::new(506,548),Point::new(506,554),Point::new(509,558),Point::new(512,561),Point::new(517,564),Point::new(521,564),Point::new(527,563),Point::new(531,560),Point::new(535,557),Point::new(538,553),Point::new(542,548),Point::new(544,544),Point::new(546,540),Point::new(546,536)]
        ]));
...
impl NDollarRecognizer{
    pub fn recognize(&self, strokes: Vec<Vec<Point>>, use_bounded_rotation_invariance:bool, require_same_no_of_strokes:bool, use_protractor:bool) -> Result{
        let t0 = Instant::now();
        ...
        for i in 0..self.multistrokes.len(){
            if !require_same_no_of_strokes || strokes.len() == self.multistrokes[i].num_strokes{// optional -- only attempt match when same # of component strokes
                for j in 0..self.multistrokes[i].unistrokes.len(){
                    if angle_between_unit_vectors(&startv, &self.multistrokes[i].unistrokes[j].start_unit_vector) <= ANGLE_SIMILARITY_THRESHOLD{// strokes start in the same direction
                        let d = 
                        if use_protractor{// for Protractor
                            optimal_cosine_distance(&self.multistrokes[i].unistrokes[j].vector, &vector)
                        }else{// Golden Section Search (original $N)
                            distance_at_best_angle(&points, &self.multistrokes[i].unistrokes[j], -ANGLE_RANGE, ANGLE_RANGE, ANGLE_PRECISION)
                        };
    ...
    pub fn add_gesture(&mut self, name:&str, use_bounded_rotation_invariance:bool, strokes:Vec<Vec<Point>>) -> usize{
        self.multistrokes.push(Multistroke::new(name, use_bounded_rotation_invariance, strokes));
        let mut num = 0;
        for i in 0..self.multistrokes.len() {
    ...
    pub fn delete_user_gestures(&mut self) -> usize {
        self.multistrokes.resize(NUM_UNISTROKES, Multistroke::default());
        NUM_UNISTROKES
    }
}
